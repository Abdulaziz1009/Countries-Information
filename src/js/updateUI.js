...
export const createCountries = (countries) => {
  cardsEl.textContent = ""; //It clears every time we search by region, so duplicates are eliminated
...
export const createCountryInfo = (country) => {
  ...
  const nativeName = Object.values(name.nativeName)[0].official; //It takes official native name from object of nativeName,
  //So, we use this syntax (Object.values(name.nativeName)[0].official) to receive 0th value's data from object
